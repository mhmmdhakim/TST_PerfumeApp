        ...
        <div className='flex justify-between items-center h-16'>
          ...
          <div className='flex items-center space-x-6'>
            ...
            >
              ...
              <span className='absolute -top-1 -right-1 bg-purple-600 text-white text-xs rounded-full h-4 w-4 flex items-center justify-center group-hover:bg-purple-700'>
                0
              </span>
            </button>
